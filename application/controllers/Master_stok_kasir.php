...
//   $nota        = $this->input->post('nota');
  ...
  $data = $this->Master_stok_kasir_model->simpan_barang($kode_barang, $stok, $nostokkasir, $image_name, $alasan, $datetime);
  echo json_encode($data);
 }
...
//   $nota     = $this->input->post('nota');
  ...
  $this->Master_stok_kasir_model->insert_trans($notrans, $ket, $id_user, $image_name, $tanggal, $datetime);
  //   $this->print($notrans);
  //   $this->session->set_flashdata('message', 'Create Record Success 2');
