...
class Stock_opname extends CI_Controller
{
    ...
    public function simpan_barang()
    {
        ...
        $isi = "kode barang : $kode_barang 
                \n nama barang : $q1->nama 
                \n stok : $stok 
                \n tanggal beli : $datetime";
        $image_name = $nama . '.png';
        qrcode($nama, $isi);
        //END QR CODE

        $data          = $this->Stock_opname_model->simpan_barang($kode_barang, $stok, $harga, $nostockopname, $datetime, $image_name);
        echo json_encode($data);
    }
    ...
    public function update_barang()
    {
        ...
        $stok            = $this->input->post('stok');
        $harga           = $this->input->post('harga');
        $data            = $this->Stock_opname_model->update_barang($stok, $harga, $id_stock_opname);
        echo json_encode($data);
    }
    ...
    public function insert_trans()
    {
        ...
        $this->Stock_opname_model->insert_trans($notrans, $id_user, $ket, $image_name,  $datetime);
        //   $this->print($notrans);
        //   $this->session->set_flashdata('message', 'Create Record Success 2');
