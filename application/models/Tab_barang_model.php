...
class Tab_barang_model extends CI_Model
{
    ...
    {
        $this->datatables->select('master_group.kode_group, master_group.nama_group, tab_barang.kode_barang, tab_barang.kode_group, tab_barang.nama, tab_barang.gambar, tab_barang.stok, tab_barang.keterangan');
